...
begin
  if (ePeso.Text = EmptyStr) then
    raise exception.Create('Área de Peso está vazia! Por favor, preencha');
  if (eAltura.Text = EmptyStr) then
    raise exception.Create('Área de Altura está vazia! Por favor, preencha');
